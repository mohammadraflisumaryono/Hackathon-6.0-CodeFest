      ...
      <header className="bg-none p-4 w-full">
        <div className="flex justify-between items-center px-6">
          ...
          <div className="flex items-center space-x-6">
            <Link to="/profil" className="text-white no-underline hover:text-gray-300">Profil</Link>
            <button className="bg-[#A5C9CA] text-black py-2 px-4 rounded-md cursor-pointer hover:bg-[#3A6A83]">
              Saldo
            </button>
          </div>
        </div>
